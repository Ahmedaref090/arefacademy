@extends('layouts.app')
@section('title', 'Students – Aref Academy')

@section('content')
<h1 class="mb-6 text-2xl font-bold">Students</h1>

<form method="GET" action="{{ route('admin.students.index') }}" class="card mb-6 grid gap-3 md:grid-cols-5">
    <input class="input" name="search" value="{{ request('search') }}" placeholder="Search name / phone…">
...
<div class="card p-0">
    <table class="w-full">
        <thead><tr class="border-b border-gray-200 dark:border-gray-800"><th class="table-th">Name</th><th class="table-th">Phone</th><th class="table-th">Governorate</th><th class="table-th">Grade</th><th class="table-th">Courses</th><th class="table-th">Joined</th></tr></thead>
        <tbody>
            ...
            @empty
                <tr><td class="table-td text-gray-400" colspan="6">No students match your filters.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
