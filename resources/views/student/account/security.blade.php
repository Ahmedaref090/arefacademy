...
@section('title', 'Security – Aref Academy')

@section('account')
<h1 class="mb-6 text-2xl font-bold">Security & Login History</h1>
...
{{-- Login history --}}
<div class="card p-0">
    <h2 class="border-b border-gray-200 p-4 font-semibold dark:border-gray-800">Recent Logins</h2>
                    ...
                    <tr class="border-b border-gray-100 dark:border-gray-800/50">
                        ...
                        <td class="table-td">
                            @if($login->isCurrentSession())
                                <span class="badge bg-emerald-100 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400">This device</span>
                            @endif
                        </td>
                    </tr>
                @empty
                    <tr><td class="table-td text-gray-400" colspan="5">No login history yet — it starts recording from your next login.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
